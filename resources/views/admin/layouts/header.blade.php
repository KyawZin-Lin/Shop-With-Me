             ...
             <ul class="navbar-nav  justify-content-end">
                 ...
                 <li class="nav-item dropdown pe-2 d-flex align-items-center">
                     ...
                     <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                             ...
                             <a class="dropdown-item border-radius-md" href="javascript:;">
                                 {{-- <div class="d-flex py-1">
                                     <div class="my-auto">
                                         ...
                                         <img src="{{ asset(auth()->guard('admin')->user()?->user_image? 'storage/' .auth()->guard('admin')->user()?->user_image: '../assets/img/team-2.jpg' ) }}"
                                             class="avatar avatar-sm border-radius-sm  me-3 ">
                                     </div>
                                     <div class="d-flex flex-column justify-content-center">
                                         <h6 class="text-sm font-weight-normal mb-1">
                                             <span class="font-weight-bold">  {{ auth()->guard('admin')->user()->name }}</span>
                         ...
                         <li class="mb-2">
                             <a class="dropdown-item border-radius-md" href="{{url('superAdmin/logout')}}">
                                 <div class="d-flex py-1">
                                     <div class="my-auto">
                                         <img src="../assets/img/small-logos/logo-google.svg"
                                             class="avatar avatar-sm border-radius-sm bg-gradient-dark p-2  me-3 ">
