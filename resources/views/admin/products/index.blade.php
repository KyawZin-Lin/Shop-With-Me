            ...
            <div class="card border shadow-xs mb-4">
                <div class="card-header border-bottom pb-0">
                    <div class="d-sm-flex align-items-center">
                        <div>
                            <h6 class="font-weight-semibold text-lg mb-0">product lists</h6>
                            <p class="text-sm">See information about all products</p>
                        </div>
                ...
                <div class="card-body px-0 py-0">
                    <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable1"
                                autocomplete="off">
                            <a href="{{ url('admin/products') }}" class="btn btn-white px-3 mb-0"
                                for="btnradiotable1">All</a href="{{ url('admin/products') }}">
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable2"
                                autocomplete="off">
                            <a href="{{ url('admin/products?user_status=pending_user') }}" class="btn btn-white px-3 mb-0"
                                for="btnradiotable2">Pending Member</a>
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable3"
                                autocomplete="off">
                            <a href="{{ url('admin/products?user_status=admin_approved_user') }}"
                                class="btn btn-white px-3 mb-0" for="btnradiotable3">Admin Approved Member</a>
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable3"
                                autocomplete="off">
                            <a href="{{ url('admin/products?user_status=superAdmin_approved_user') }}"
                                ...
                                @foreach ($products as $product)
                                    <tr class="text-center">
                                        ...
                                        {{-- <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal"><b>{{ $product->membership_expiry }}</b></span>
                                        </td> --}}
                                        {{-- <td class="align-middle text-center text-sm">
                                            <div class="col-md-4">

                                                @include('components.partials.admin-approve-model-box')
                                                <button type="button" @if ($product->user_status == 'admin_approved_user' || $product->user_status == 'superAdmin_approved_user') disabled @endif
                                                    class="btn btn-sm btn-block btn-dark mb-3" data-bs-toggle="modal"
                                                    data-bs-target="{{"#admin-approve-model-$product->id"}}">{{ $product->user_status }}</button>

                                            </div>
                                            <span> <a class=" btn badge badge-sm border border-success text-success bg-success" href="{{url("admin/user/$product->id/approve")}}"> {{ $product->user_status }}</a></span>
                                        </td> --}}
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $product->name }}</span>
                                        </td>
                                        <td>
                                            <div class="d-flex  justify-content-center px-2 py-1">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    @if ($product->product_image != null)
                                                        <a target="blink"
                                                            href="{{ asset("storage/product-image/$product->product_image") }}">
                                                            <img src="{{ asset("storage/product-image/$product->product_image") }}"
                                                                class="avatar avatar-lg  me-2" alt="user1">
                                                        </a>
                                                    @else
                                                        <img src="../assets/img/team-2.jpg" class="avatar avatar-lg  me-2"
                                                            alt="user1">
                                                    @endif
                                                </div>
                                                {{-- <div class="d-flex flex-column justify-content-center ms-1">
                                                    <h6 class="mb-0 text-sm font-weight-semibold">{{ $product->name }}</h6>
                                                    <p class="text-sm text-secondary mb-0">{{ $product->email }}
                                                    </p>
                                                </div> --}}
                                            </div>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $product->brand?->name }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $product->category?->name }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $product->subCategory?->name }}</span>
                                        </td>
                                        {{-- <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $product->phone }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $product->address }}</span>
                                        </td> --}}

                                        <td class="d-flex justify-content-center gap-2">

                                            <a class="btn btn-sm" href="{{ url("admin/products/$product->id/edit") }}"
                                            ...
                                            <a class="btn btn-sm" href="{{ url("admin/products/$product->id") }}"
                                                class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip"
                    ...
                    <div class="border-top py-3 px-3 d-flex align-items-center">
                        <p class="font-weight-semibold mb-0 text-dark text-sm">Page {{ $products->currentPage() }} of
                            {{ $products->lastPage() }}</p>
                        <div class="ms-auto">
                            {{-- @if ($products->previousPageUrl())
                                <a href="{{ $products->previousPageUrl() }}" class="btn btn-sm btn-white mb-0">Previous</a>
                            @endif
                                {{dd($products)}}
                            @if ($products->nextPageUrl())
                                <a href="{{ $products->nextPageUrl() }}" class="btn btn-sm btn-white mb-0">Next</a>
                            @endif --}}
                            {{ $products }}
                        </div>
                    </div>
