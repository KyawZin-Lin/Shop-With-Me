            ...
            <div class="card border shadow-xs mb-4">
                <div class="card-header border-bottom pb-0">
                    <div class="d-sm-flex align-items-center">
                        <div>
                            <h6 class="font-weight-semibold text-lg mb-0">Sub Category lists</h6>
                            <p class="text-sm">See information about all Sub Categories</p>
                        </div>
                        <div class="ms-auto d-flex">
                            ...
                            <a href="{{ url('admin/subCategories/create') }}"
                                ...
                                <span class="btn-inner--text">Add Sub-subCategory</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="card-body px-0 py-0">
                    <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable1"
                                autocomplete="off">
                            <a href="{{ url('admin/subCategories') }}" class="btn btn-white px-3 mb-0"
                                for="btnradiotable1">All</a href="{{ url('admin/subCategories') }}">
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable2"
                                autocomplete="off">
                            <a href="{{ url('admin/subCategories?user_status=pending_user') }}"
                                class="btn btn-white px-3 mb-0" for="btnradiotable2">Pending Member</a>
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable3"
                                autocomplete="off">
                            <a href="{{ url('admin/subCategories?user_status=admin_approved_user') }}"
                                class="btn btn-white px-3 mb-0" for="btnradiotable3">Admin Approved Member</a>
                            <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable3"
                                autocomplete="off">
                            <a href="{{ url('admin/subCategories?user_status=superAdmin_approved_user') }}"
                                class="btn btn-white px-3 mb-0" for="btnradiotable3">SuperAdmin Approved Member</a>
                        </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr class="text-center">
                                    <th class="text-secondary text-xs font-weight-semibold opacity-7">ID
                                    </th>
                                ...
                                @foreach ($subCategories as $subCategory)
                                    <tr class="text-center">
                                        {{-- <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex align-items-center">
                                                    @if ($subCategory->user_image != null)
                                                        <a target="blink"
                                                            href="{{ asset("storage/user-image/$subCategory->user_image") }}">
                                                            <img src="{{ asset("storage/user-image/$subCategory->user_image") }}"
                                                ...
                                                <div class="d-flex flex-column justify-content-center ms-1">
                                                    <h6 class="mb-0 text-sm font-weight-semibold">{{ $subCategory->name }}</h6>
                                                    <p class="text-sm text-secondary mb-0">{{ $subCategory->email }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td> --}}
                                        ...
                                        {{-- <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal"><b>{{ $subCategory->membership_expiry }}</b></span>
                                        </td> --}}
                                        {{-- <td class="align-middle text-center text-sm">
                                            <div class="col-md-4">

                                                @include('components.partials.admin-approve-model-box')
                                                <button type="button" @if ($subCategory->user_status == 'admin_approved_user' || $subCategory->user_status == 'superAdmin_approved_user') disabled @endif
                                                    class="btn btn-sm btn-block btn-dark mb-3" data-bs-toggle="modal"
                                                    data-bs-target="{{"#admin-approve-model-$subCategory->id"}}">{{ $subCategory->user_status }}</button>

                                            </div>
                                            <span> <a class=" btn badge badge-sm border border-success text-success bg-success" href="{{url("admin/user/$subCategory->id/approve")}}"> {{ $subCategory->user_status }}</a></span>
                                        </td> --}}
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $subCategory->name }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $subCategory->category?->name }}</span>
                                        </td>
                                        {{-- <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $subCategory->phone }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-sm font-weight-normal">{{ $subCategory->address }}</span>
                                        </td> --}}

                                        <td class="d-flex justify-content-center gap-2">

                                            <a class="btn btn-sm"
                                                href="{{ url("admin/subCategories/$subCategory->id/edit") }}"
                                                class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip"
                                                data-bs-title="Edit subCategory">
                                            ...
                                            <a class="btn btn-sm" href="{{ url("admin/subCategories/$subCategory->id") }}"
                                                class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip"
                    ...
                    <div class="border-top py-3 px-3 d-flex align-items-center">
                        <p class="font-weight-semibold mb-0 text-dark text-sm">Page {{ $subCategories->currentPage() }} of
                            {{ $subCategories->lastPage() }}</p>
                        <div class="ms-auto">
                            {{-- @if ($subCategories->previousPageUrl())
                                <a href="{{ $subCategories->previousPageUrl() }}" class="btn btn-sm btn-white mb-0">Previous</a>
                            @endif
                                {{dd($subCategories)}}
                            @if ($subCategories->nextPageUrl())
                                <a href="{{ $subCategories->nextPageUrl() }}" class="btn btn-sm btn-white mb-0">Next</a>
                            @endif --}}
                            {{ $subCategories }}
                        </div>
                    </div>
